...
describe('mergeSoftParagraphBreaks', () => {
  it('joins continuation lines after incomplete sentence', () => {
    const a =
      'The prospectus supplement relating to the offering was filed pursuant to Rule 424(b) under the Securities Act';
    const b =
      'and a final prospectus relating to the offering has been filed with the SEC.';
