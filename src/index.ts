...
export {
  assertLayer2ClauseBlock,
  assertLayer2ClauseBlocks,
  assertLayer2FilingCanonicalOwnership,
} from './understanding/validate-layer2.js';
export { mergeTerminationDomainIntoCanonical } from './understanding/layer2-canonical-merge.js';
export {
  DOMAIN_BY_CLAUSE_TYPE,
  PRIORITY_BY_TYPE,
  applyStrictExtractedFields,
} from './understanding/layer2-field-ownership.js';
export {
  LAYER2_CLAUSE_BLOCK_JSON_KEYS,
  normalizeClauseBlockOrder,
  prepareLayer2ClauseForExport,
  prepareLayer2ClausesForExport,
  stringifyLayer2ClausesStable,
} from './understanding/layer2-clause-order.js';
