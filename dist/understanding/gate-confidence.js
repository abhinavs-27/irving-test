 ...
 */
export function buildLowBandFields(signalCodes) {
 ...
 */
export function reduceFieldsForMediumConfidence(clauseType, fields) {
    const out = {};
    switch (clauseType) {
        case 'pricing_terms': {
            ...
            if (Array.isArray(fields.discount_terms)) {
                out.discount_terms = fields.discount_terms.map((d) => {
                    const o = {};
                    if (d.mechanism != null)
                        o.mechanism = d.mechanism;
                    if (d.value_percent != null)
                        o.value_percent = d.value_percent;
                    if (d.applies_to != null)
                        o.applies_to = d.applies_to;
                    return o;
                });
            }
            break;
        ...
        case 'payment':
            if (fields.amounts_usd != null)
                out.amounts_usd = fields.amounts_usd;
            if (fields.timing_code != null)
                out.timing_code = fields.timing_code;
        ...
        case 'confidentiality':
            if (fields.scope_codes != null)
                out.scope_codes = fields.scope_codes;
            break;
        default:
            break;
    }
...
//# sourceMappingURL=gate-confidence.js.map