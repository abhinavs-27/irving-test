...
export function validateClauseId(id, context) {
 ...
 */
export function isProbableClauseNumbering(id) {
    const t = normalizeClauseId(id);
    if (/[.(]/.test(t))
        return true;
    if (/^\d{1,2}$/.test(t))
...
//# sourceMappingURL=clause-id.js.map