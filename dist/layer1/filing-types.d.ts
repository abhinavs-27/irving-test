...
import type { DocumentRelationship, EntityRegistry, FactsV2, GraphEvent, Layer1ClauseSignals, SectionConstraintEntry, SectionEntities, ClausePricingLayer1 } from './types.js';
...
export declare const LAYER1_FILING_SCHEMA_ID: "https://irving.local/schemas/layer1-filing.schema.json";
export declare const SCHEMA_ENUM_BLOCK_TYPE: readonly ["structural", "pricing_mechanism", "constraint", "termination", "regulatory_disclosure"];
/** User-facing label “disclosure” maps to `regulatory_disclosure` (see schema `description`). */
export declare const SCHEMA_ENUM_RELATIONSHIP_TYPE: readonly ["defines", "constrains", "governs", "references", "triggers"];
//# sourceMappingURL=filing-types.d.ts.map